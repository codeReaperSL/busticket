...
void main() {
  runApp(
    ChangeNotifierProvider(
      ...
      child: BusSeatBookingApp(),
    ),
  );
}

class BusSeatBookingApp extends StatelessWidget {
  const BusSeatBookingApp({super.key});
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ForgotPasswordMethodPage()),
                    );
                  },
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => BusownerForgotPasswordPage()),
                  );
                },
                child: Text('Forgot Password?',
                    style: TextStyle(color: Colors.orange)),
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => BusownerSignupPage()),
                    );
                  },
                  child: Text('Sign Up',
                      style: TextStyle(
...
class BusownerHomeScreen extends StatefulWidget {
  const BusownerHomeScreen({super.key});
...
class BusownerSettingpage extends StatelessWidget {
  const BusownerSettingpage({super.key});
...
class OwnerSeatManagement extends StatefulWidget {
  const OwnerSeatManagement({super.key});
                ...
                itemBuilder: (context, rowIndex) {
                  return Column(
                    children: [
                      ...
                      if (rowIndex != seatCount ~/ 4 - 1) SizedBox(height: 16),
                    ],
                  );
                },
              ),
          ...
          children: [
            ...
            if (selectedSeatNumber != null)
              ElevatedButton(
                ...
                child: Text(
                  seatStatus[selectedSeatNumber! - 1]
                      ? 'Make Unavailable'
                      : 'Make Available',
                ),
              ),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ownerSetPasswordPage()),
                );
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.orange,
...
class ownerSetPasswordPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          AppBar(title: Text('Set Password'), backgroundColor: Colors.orange),
      body: Center(
        child: SingleChildScrollView(
          padding: EdgeInsets.all(16.0),
          child: Column(
...
class BusownerForgotPasswordPage extends StatelessWidget {
  const BusownerForgotPasswordPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text('Forgot Password'), backgroundColor: Colors.orange),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text('Select OTP Method',
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            OTPVerificationPage(method: 'SMS')));
              },
              style: ElevatedButton.styleFrom(backgroundColor: Colors.orange),
              child: Text('Send OTP via SMS',
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            OTPVerificationPage(method: 'Email')));
              },
              style: ElevatedButton.styleFrom(backgroundColor: Colors.orange),
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => UserSeatSelection()),
                );
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.orange,
...
class UserSeatSelection extends StatefulWidget {
  const UserSeatSelection({super.key});
...
class OTPVerificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text('Verify OTP - $method'), backgroundColor: Colors.orange),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
